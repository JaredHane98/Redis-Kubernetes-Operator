...
func (b *builder) SetLoadBalancerClass(loadBalancerType string) *builder {
	b.loadBalancerClass = &loadBalancerType
	return b
}
...
func (b *builder) SetPort(port corev1.ServicePort) *builder {
...
func (b *builder) SetOwnerReferences(ownerReferences []metav1.OwnerReference) *builder {
	b.ownerReferences = append(b.ownerReferences, ownerReferences...)
	return b
}

func (b *builder) SetOwnerReference(ownerReference metav1.OwnerReference) *builder {
	b.ownerReferences = append(b.ownerReferences, ownerReference)
	return b
}
...
func (b *builder) Build() corev1.Service {
	return corev1.Service{
		...
		Spec: corev1.ServiceSpec{
			...
			Ports:                    b.servicePort,
			Selector:                 b.selector,
			LoadBalancerClass:        b.loadBalancerClass,
		},
	}
}
